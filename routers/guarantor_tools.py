...
@mcp.tool(name="Get Guarantor Template")
...
@mcp.tool(name="Get Guarantor List")
...
@mcp.tool(name="Create Guarantor")
...
@mcp.tool(name="Update Guarantor")
...
@mcp.tool(name="Delete Guarantor")
